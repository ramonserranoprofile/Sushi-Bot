...
const getFaqByQuestion = async (req, res) => {
    ...
    try {
        ...
        // Segun el horario de trabajo de la semana, extrae la hora de cierre
        ...
        // Función para convertir hora en formato 12 horas a 24 horas
